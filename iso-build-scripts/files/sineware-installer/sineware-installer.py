...
print("-------------------------------------------------------------------")
print("Welcome to the Sineware EL Server installer for x86!")
print("This software is a TECH PREVIEW! It *will* break.")
print()
...
# (128M Boot partition, 1G Root A, 1G Root B, rest Data partition)
disk_config = """
label: dos
label-id: 0xdfefdc32
unit: sectors
...
start=  2361344, size= 2097152, type= 83
...
os.system("mkfs.ext4 " + install_disk + "4")
